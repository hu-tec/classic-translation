              ...
              <form onSubmit={(e) => { e.preventDefault(); setSubmitted(true); }} className="space-y-10">
                ...
                <div className="grid grid-cols-2 gap-8">
                  <div className="space-y-3">
                    ...
                    <input required type="text" className="w-full bg-[#FDFCF8] border-none p-5 focus:ring-1 focus:ring-[#8C2323] outline-none transition-all font-serif" />
                  </div>
                  <div className="space-y-3">
                    <label className="text-[10px] font-bold uppercase tracking-widest text-[#8C2323]">전공 분야</label>
                    <input required type="text" placeholder="예: 한국사학" className="w-full bg-[#FDFCF8] border-none p-5 focus:ring-1 focus:ring-[#8C2323] outline-none transition-all font-serif" />
                  </div>
                </div>

                <div className="space-y-3">
                  <label className="text-[10px] font-bold uppercase tracking-widest text-[#8C2323]">최종 학위 및 경력</label>
                  <textarea required rows={4} className="w-full bg-[#FDFCF8] border-none p-5 focus:ring-1 focus:ring-[#8C2323] outline-none transition-all font-serif resize-none"></textarea>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <input type="text" placeholder="구글 드라이브 또는 드롭박스 링크" className="w-full bg-[#FDFCF8] border-none p-5 focus:ring-1 focus:ring-[#8C2323] outline-none transition-all font-serif" />
                </div>

                <button type="submit" className="w-full bg-[#8C2323] text-white py-6 font-black tracking-[0.4em] hover:bg-[#6D1B1B] transition-all shadow-xl shadow-[#8C2323]/20 flex items-center justify-center gap-4 group uppercase">
                  제출하기 <ChevronRight className="w-6 h-6 group-hover:translate-x-2 transition-transform" />
                </button>
              </form>
            )}
          </div>
